...
url = BeautifulSoup(page.text,"html.parser")

def scrape_top_list():

    list = []
    div = url.find("div",class_="body_main container")
    ...
    for i in tr:
        ...
        for j in td:
            ...
            dict1["Movie_Name"] = movieName

            movieurl = i.find("a",class_ = "unstyled articleLink")["href"]
            link = "https://www.rottentomatoes.com" + movieurl
            dict1["Url"] = link
